...
import { OMNIDEF } from './rFIPGetABSCalcResponseProcedure_def.js';
import tmpl from './rFIPGetABSCalcResponseProcedure.html';
import tmpl_nds from './rFIPGetABSCalcResponseProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class rFIPGetABSCalcResponseProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
