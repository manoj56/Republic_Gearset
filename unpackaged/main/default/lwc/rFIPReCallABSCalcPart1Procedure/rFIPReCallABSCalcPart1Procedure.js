...
import { OMNIDEF } from './rFIPReCallABSCalcPart1Procedure_def.js';
import tmpl from './rFIPReCallABSCalcPart1Procedure.html';
import tmpl_nds from './rFIPReCallABSCalcPart1Procedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class rFIPReCallABSCalcPart1Procedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
