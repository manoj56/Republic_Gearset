...
import { OMNIDEF } from './rFIPGetABSCalcpart2Procedure_def.js';
import tmpl from './rFIPGetABSCalcpart2Procedure.html';
import tmpl_nds from './rFIPGetABSCalcpart2Procedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class rFIPGetABSCalcpart2Procedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
