...
import { OMNIDEF } from './rFIPCreateOfferOnClickOfNewOfferProcedure_def.js';
import tmpl from './rFIPCreateOfferOnClickOfNewOfferProcedure.html';
import tmpl_nds from './rFIPCreateOfferOnClickOfNewOfferProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class rFIPCreateOfferOnClickOfNewOfferProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
